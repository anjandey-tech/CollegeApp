...
import com.inturnsala.admincollegeapp.NoticeData;
import com.inturnsala.admincollegeapp.R;
import com.inturnsala.admincollegeapp.UploadImage;
import com.inturnsala.admincollegeapp.UploadNotice;
import com.inturnsala.admincollegeapp.UploadPdfActivity;
...
public class AddTeacher extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        String [] items = new String[]{"Select Category", "Computer Science","Mechanical Engineering",
                "Electrical Engineering","Civil Engineering","B C A", "B B A"};
    ...
    private void uploadImage() {
        ...
        bitmap.compress(Bitmap.CompressFormat.JPEG,15,boas);
        ...
        uploadTask.addOnCompleteListener(AddTeacher.this, new OnCompleteListener<UploadTask.TaskSnapshot>() {
            ...
            public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                if(task.isSuccessful()){
                    ...
                    pd.dismiss();
                    Toast.makeText(AddTeacher.this,"Something went wrong",Toast.LENGTH_SHORT);
                }
            }
        });
    }
